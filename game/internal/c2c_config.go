...
const (
	...
	msgBankerStatus      string = "/GameServer/GameUser/changeAccountBankerAndStatus"
	msgBankerWinScore    string = "/GameServer/GameUser/bankerWinSettlement"
	msgBankerLoseScore   string = "/GameServer/GameUser/bankerLoseSettlement"
)
...
type BankerReqInfo struct {
	Auth UserAuth      `json:"auth"`
	Info BankerReqData `json:"info"`
}
