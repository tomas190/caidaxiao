...
func init() {
	...
	msg.Processor.SetRouter(&msg.Login_C2S{}, game.ChanRPC)  // login
	msg.Processor.SetRouter(&msg.Logout_C2S{}, game.ChanRPC) // login

	msg.Processor.SetRouter(&msg.JoinRoom_C2S{}, game.ChanRPC)
	msg.Processor.SetRouter(&msg.LeaveRoom_C2S{}, game.ChanRPC)

	msg.Processor.SetRouter(&msg.PlayerAction_C2S{}, game.ChanRPC) // login
